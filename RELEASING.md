...
- Mudança em `scripts/install-claude-hooks.mjs` ou `scripts/claude-hooks/*` (camada cliente de captura — o aluno SÓ recebe hooks novos via pacote/`git pull` + `npm run setup`)
