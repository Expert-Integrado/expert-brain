...
async function main() {
  ...
  console.log(`  ${BOLD}npm run setup${RESET}          ${DIM}# 2 perguntas (email + senha), espera ~3min${RESET}`);
  console.log(`\n${DIM}O script de setup imprime no final a URL do Worker, o comando MCP pra conectar no Claude,${RESET}`);
  console.log(`${DIM}e o link do dashboard. Boa! 🧠${RESET}\n`);
}
