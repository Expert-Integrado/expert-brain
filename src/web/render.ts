...
<div class="shell${collapsed ? ' sidebar-collapsed' : ''}">
  <aside class="sidebar">
    ...
    <a class="nav-item" href="/app/contacts-sso" title="Contatos (Expert Contacts)">${SIDEBAR_ICONS.contacts}<span class="nav-label">Contatos</span></a>
...
<nav class="bottom-nav" role="navigation" aria-label="Navegação principal">
  ...
  <a class="bottom-nav-item" href="/app/contacts-sso" aria-label="Contatos (Expert Contacts)">
